...
-  Search Text: full text search inside the collections. If you leave the
...
- Dates (effective, created, ...):  will be converted to  date ranges and can
  be selected with the JQuery Slider Plugin)
- Location (path index): will not be displayed in the search form and always be
  applied to the query
- Keyword Indices (like tags): a drop down list will be generated to narrow the
  search down
...
Installation
============
You can install collective.flexitopic as part of a specific project's
